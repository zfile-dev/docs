...
<span class="font-bold">tips：如从开源版 4.x 版本升级到的捐赠版，想要保留之前的数据，需将下文中的 `/root/zfile-pro/db:/root/.zfile-v4/db` 中的左侧 `/root/zfile-pro/db` 修改为 `/root/zfile-pro/db`，否则会创建新的数据库.</span>
